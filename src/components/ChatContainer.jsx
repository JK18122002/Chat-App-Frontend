...
const ChatContainer = () => {
  ...
  const {messages, users, selectedUser, setSelectedUser, getUsers, sendMessage, UnseenMessages, setUnseenMessages, getMessages} = useContext(ChatContext)
  ...
  }, [messages]) // depend on length so it auto-scrolls
